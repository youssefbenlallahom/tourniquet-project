...
urlpatterns = [
    ...
    path('assignment_access/create/', add_assignment_access, name='add_assignment_access'),
    path('assignment_access/delete/<int:Assignment_accessId>/', delete_assignment_access, name='delete_assignment_access'),
    path('assignment_access/update/<int:Assignment_accessId>/', update_assignment_access, name='update_assignment_access'), 
    path('assignment_access/all/', view_assignment_access, name='view_assignment'),
